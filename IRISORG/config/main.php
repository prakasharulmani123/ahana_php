    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/roomchargecategory'], 'extraPatterns' => ['POST remove' => 'remove']],
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/roomchargesubcategory'], 'extraPatterns' => ['POST remove' => 'remove']],
