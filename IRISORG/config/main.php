    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/pharmacydrugclass'], 'extraPatterns' => ['POST remove' => 'remove', 'GET getdruglist' => 'getdruglist']],
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/pharmacyproduct'], 'extraPatterns' => ['POST remove' => 'remove', 'GET getproductlist' => 'getproductlist']],
