    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/roomchargesubcategory'], 'extraPatterns' => ['POST remove' => 'remove', 'GET getroomchargesubcategorylist' => 'getroomchargesubcategorylist']],
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/doctorschedule'], 'extraPatterns' => ['POST remove' => 'remove', 'POST createschedule' => 'createschedule', 'GET getschedule' => 'getschedule']],
