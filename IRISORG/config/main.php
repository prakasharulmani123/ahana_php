    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/admission'], 'extraPatterns' => ['POST remove' => 'remove', 'POST patientswap' => 'patientswap', 'POST canceladmission' => 'canceladmission']],
                ...
                ['class' => 'yii\rest\UrlRule', 'controller' => ['v1/pharmacypurchase'], 'extraPatterns' => ['POST remove' => 'remove', 'POST savepurchase' => 'savepurchase', 'GET reportlist' => 'reportlist']],
