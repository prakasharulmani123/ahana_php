app.controller('dischargedPatientPharmacyController', ['$rootScope', '$scope', '$timeout', '$http', '$state', '$anchorScroll', '$filter', function ($rootScope, $scope, $timeout, $http, $state, $anchorScroll, $filter) {
        ...
        $scope.loadReport = function () {
            ...
            $http.post($rootScope.IRISOrgServiceUrl + '/myworkreports/dischargedpatientpharmacycharge?addtfields=salereport', data)
            ...
            angular.forEach(branch_wise, function (details, branch_name) {
                ...
                angular.forEach(details, function (row, key) {
                    ...
                    branches.push([
                        ...
                        row.encounter_id,
                        row.bill_no,
                        moment(row.sale_date).format('DD-MM-YYYY'),
                        Payment,
                        row.bill_amount,
                    ]);
                    serial_no++;
                    ...
                    columns: [
                        {
                            text: [
                                ...
                                'Discharged Patient Pharmacy Charge'
                            ],
                            margin: [0, 0, 0, 20]
                        },
                        {
