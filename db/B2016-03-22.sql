...
insert  into `pat_billing_extra_concession`(`ec_id`,`tenant_id`,`encounter_id`,`patient_id`,`ec_type`,`link_id`,`extra_amount`,`concession_amount`,`status`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (7,58,100,39,'P',22,'100.00','0.00','1',1,'2016-03-21 12:23:49',NULL,NULL,'0000-00-00 00:00:00'),(8,58,108,40,'P',22,'0.00','100.00','1',51,'2016-03-21 18:08:44',51,'2016-03-21 18:08:44','0000-00-00 00:00:00'),(9,58,108,40,'C',54,'2000.00','150.00','1',51,'2016-03-21 18:14:11',51,'2016-03-21 18:45:40','0000-00-00 00:00:00');
...
insert  into `pat_patient_casesheet`(`casesheet_id`,`tenant_id`,`patient_id`,`casesheet_no`,`start_date`,`end_date`,`status`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (3,58,39,'785451','2016-03-14',NULL,'1',51,'2016-03-14 13:33:49',51,'2016-03-14 13:33:49','0000-00-00 00:00:00'),(4,58,34,'5154151','2016-03-14',NULL,'1',51,'2016-03-15 11:29:33',NULL,NULL,'0000-00-00 00:00:00'),(5,58,23,'7848511','2016-03-15',NULL,'1',51,'2016-03-15 13:06:53',51,'2016-03-15 13:06:53','0000-00-00 00:00:00'),(6,58,26,'15411','2016-03-15',NULL,'1',51,'2016-03-15 16:55:37',51,'2016-03-15 16:55:37','0000-00-00 00:00:00'),(7,58,37,'A','2016-03-16',NULL,'1',51,'2016-03-16 17:17:36',51,'2016-03-16 17:17:36','0000-00-00 00:00:00'),(8,58,40,'000141','2016-03-21',NULL,'1',51,'2016-03-21 15:57:41',51,'2016-03-21 15:57:41','0000-00-00 00:00:00');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_billing_advance_charges` AS (select `a`.`tenant_id` AS `tenant_id`,`a`.`encounter_id` AS `encounter_id`,`a`.`patient_id` AS `patient_id`,`a`.`payment_id` AS `category_id`,'Advance Charge' AS `category`,concat('Payment(',`a`.`payment_id`,')') AS `headers`,0 AS `charge`,0 AS `visit_count`,'C' AS `trans_mode`,`a`.`payment_amount` AS `total_charge`,0 AS `extra_amount`,0 AS `concession_amount` from `pat_billing_payment` `a` where ((`a`.`status` = '1') and (`a`.`deleted_at` = '0000-00-00 00:00:00'))) */;
