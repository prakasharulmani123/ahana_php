...
CREATE TABLE `pat_appoinment` (
  ...
  `notes` text,
  `sub_charge_id` int(11) DEFAULT NULL,
  `sub_charge_amount` decimal(10,2) DEFAULT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_by` int(11) DEFAULT NULL,
  `modified_at` timestamp NULL DEFAULT NULL,
...
insert  into `pat_appoinment`(`appt_id`,`tenant_id`,`patient_id`,`encounter_id`,`status_date`,`status_time`,`consultant_id`,`appt_status`,`status`,`amount`,`notes`,`sub_charge_id`,`sub_charge_amount`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (1,18,1,1,'2016-01-25','12:00:00',28,'B','1','0.00',NULL,NULL,NULL,1,'2016-01-25 17:54:17',1,'2016-01-25 17:54:17','0000-00-00 00:00:00'),(2,18,1,1,'2016-01-25','12:15:00',28,'A','1','0.00',NULL,NULL,NULL,1,'2016-01-25 18:53:43',NULL,NULL,'0000-00-00 00:00:00'),(3,18,2,3,'2016-01-29','00:00:00',27,'B','1','0.00',NULL,NULL,NULL,1,'2016-01-29 15:22:49',1,'2016-01-29 15:22:49','0000-00-00 00:00:00'),(4,18,2,4,'2016-01-29','01:00:00',27,'B','1','0.00',NULL,NULL,NULL,1,'2016-01-29 15:23:26',1,'2016-01-29 15:23:26','0000-00-00 00:00:00'),(5,18,1,5,'2016-01-29','01:00:00',28,'B','1','0.00',NULL,NULL,NULL,1,'2016-01-30 15:08:50',1,'2016-01-30 15:08:50','0000-00-00 00:00:00'),(6,18,1,5,'2016-01-29','01:00:00',28,'A','1','0.00',NULL,NULL,NULL,1,'2016-01-30 15:08:50',1,'2016-01-30 15:08:50','0000-00-00 00:00:00');
