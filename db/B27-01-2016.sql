...
CREATE TABLE `pat_admission` (
  ...
  `room_id` int(11) NOT NULL,
  `room_type_id` int(11) NOT NULL,
  `admission_status` enum('A','D') NOT NULL DEFAULT 'A' COMMENT 'A - Admission, D-Discharge',
  `status` enum('0','1') DEFAULT '1',
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modified_by` int(11) DEFAULT NULL,
...
insert  into `pat_admission`(`admn_id`,`tenant_id`,`patient_id`,`encounter_id`,`status_date`,`consultant_id`,`floor_id`,`ward_id`,`room_id`,`room_type_id`,`admission_status`,`status`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (1,18,1,2,'2015-01-26 00:00:00',2,2,1,1,1,'A','1',1,'2016-01-27 18:57:01',NULL,NULL,'0000-00-00 00:00:00');
...
insert  into `pat_appoinment`(`appt_id`,`tenant_id`,`patient_id`,`encounter_id`,`appoinment_date`,`appoinment_time`,`consultant_id`,`appt_status`,`status`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (1,18,1,1,'2016-01-25','12:00:00',28,'B','1',1,'2016-01-25 17:54:17',1,'2016-01-25 17:54:17','0000-00-00 00:00:00'),(2,18,1,1,'2016-01-25','12:15:00',28,'A','1',1,'2016-01-25 18:53:43',NULL,NULL,'0000-00-00 00:00:00');
...
insert  into `pat_encounter`(`encounter_id`,`tenant_id`,`patient_id`,`encounter_type`,`encounter_date`,`inactive_date`,`finalize`,`authorize`,`casesheetno`,`status`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (1,18,1,'OP','2016-01-25 17:54:17',NULL,0,0,NULL,'1',1,'2016-01-25 17:54:17',1,'2016-01-25 17:54:17','0000-00-00 00:00:00'),(2,18,1,'IP','2016-01-27 18:56:18',NULL,0,0,NULL,'1',1,'2016-01-27 18:56:18',NULL,NULL,'0000-00-00 00:00:00');
...
insert  into `pat_patient`(`patient_id`,`tenant_id`,`patient_reg_date`,`patient_title_code`,`patient_firstname`,`patient_lastname`,`patient_relation_code`,`patient_relation_name`,`patient_care_taker`,`patient_care_taker_name`,`patient_dob`,`patient_temp_dob`,`patient_gender`,`patient_marital_status`,`patient_occupation`,`patient_blood_group`,`patient_category_id`,`patient_email`,`patient_reg_mode`,`patient_type`,`patient_ref_hospital`,`patient_ref_id`,`patient_mobile`,`patient_bill_type`,`status`,`created_by`,`created_at`,`modified_by`,`modified_at`,`deleted_at`) values (1,18,'2016-01-27 12:42:32','Mr.','Prakah',NULL,NULL,NULL,NULL,NULL,'1990-07-30',NULL,'M',NULL,NULL,NULL,1,NULL,'OP',NULL,NULL,NULL,NULL,'N','1',1,'2016-01-23 13:51:03',1,'2016-01-23 13:51:03','0000-00-00 00:00:00'),(2,18,'2016-01-27 12:37:44','Mr.','Nadesh',NULL,NULL,NULL,NULL,NULL,NULL,'1956-01-23','M',NULL,NULL,NULL,1,NULL,'NO',NULL,NULL,NULL,NULL,'N','1',1,'2016-01-23 14:18:50',1,'2016-01-23 14:18:50','0000-00-00 00:00:00'),(3,18,'2016-01-27 12:37:47','Mr.','Prakah Arul Mani','Paramanandam',NULL,NULL,NULL,NULL,'1990-07-30',NULL,'M',NULL,NULL,NULL,1,NULL,'NO',NULL,NULL,NULL,'9566659581','F','1',1,'2016-01-23 17:57:23',1,'2016-01-23 17:57:23','0000-00-00 00:00:00');
