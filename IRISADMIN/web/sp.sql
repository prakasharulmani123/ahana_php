...
pha_stock_latest_purchase(tenant_id, report_date, batch_id, 'purchase_rate') AS purchase_rate,
...
FROM (
SELECT a.batch_id, c.batch_no, d.product_name, SUM(a.quantity * a.package_unit) + SUM(a.free_quantity * a.free_quantity_package_unit) AS total_purchase_qty, 0 AS total_sale_quantity
...
GROUP BY a.batch_id
UNION ALL
SELECT a.batch_id, c.batch_no, d.product_name, SUM(a.quantity * a.package_unit)  AS total_purchase_qty, 0 AS total_sale_quantity
...
GROUP BY a.batch_id
UNION ALL
SELECT a.batch_id, c.batch_no, d.product_name, 0 AS total_purchase_qty, SUM(a.quantity)  AS total_sale_quantity
...
GROUP BY a.batch_id
UNION ALL
SELECT a.batch_id, b.batch_no, c.product_name, SUM(a.adjust_qty)  AS total_purchase_qty, 0 AS total_sale_quantity
