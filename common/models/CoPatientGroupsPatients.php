...
use common\models\query\CoPatientGroupsPatientsQuery;
use Yii;
 ...
 */
class CoPatientGroupsPatients extends ActiveRecord {
    ...
    public static function find() {
        return new CoPatientGroupsPatientsQuery(get_called_class());
    }
