...
class PhaPurchaseItem extends PActiveRecord {
    ...
    public function rules() {
        return [
                ...
                [['mrp', 'purchase_rate', 'purchase_amount', 'discount_percent', 'discount_amount', 'total_amount', 'vat_amount', 'vat_percent', 'cgst_amount', 'cgst_percent', 'sgst_amount', 'sgst_percent', 'taxable_value'], 'number'],
                [['status'], 'string'],
