...
//    }
    ...
    public function rules() {
        return [
                ...
                ['patient_mobile', 'match', 'pattern' => '/^[6789]\d{9}$/', 'message' => 'Invalid mobile number'],
                ['patient_secondary_contact', 'match', 'pattern' => '/^[0-9]{10}$/', 'message' => 'Secondary contact must be 10 digits only'],
                ['patient_secondary_contact', 'match', 'pattern' => '/^[6789]\d{9}$/', 'message' => 'Invalid secondary contact'],
                ['patient_email', 'email'],
        ...
        if ($addtField = Yii::$app->request->get('addtfields')) {
            switch ($addtField):
                ...
                case 'merge_search':
                    ...
                    break;
                case 'prescregister':
                    $addt_keys = ['fullname', 'patient_global_int_code'];
                    break;
            endswitch;
        }
